...
export default function OpenCart({
  ...
  return (
    <div className="relative flex h-11 w-11 group items-center cursor-pointer hover:bg-primary/20 justify-center rounded-md border-neutral-200 text-black transition-colors dark:border-neutral-700 dark:text-white">
      <svg
    ...
    >
      ...
      <g>
        ...
        />
        <style>{`
          .group:hover .cart-box {
            fill: #CDE9F7 !important;
          }
        `}</style>
      </g>
...
<g className=''>
      ...
      {quantity ? (
        <div className="absolute font-body -right-3 -top-2 px-2 py-1 leading-none rounded-full bg-primary text-[11px] font-medium text-white">
          {quantity}
        </div>
      ) : null}
    </div>
